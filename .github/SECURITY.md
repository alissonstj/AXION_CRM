...
- [GitHub Security Advisories](https://github.com/alissonstj/AXION_CRM/security/advisories/new)
  (preferred — keeps the disclosure, fix, and CVE all in one place).
- Email: `TODO: add your security contact email` with `[AXION CRM PRO security]` in the subject.
...
In scope:
- Anything in this repository (`alissonstj/AXION_CRM`), including webhook and auth
